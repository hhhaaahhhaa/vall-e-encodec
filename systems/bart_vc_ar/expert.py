...
from .model import CustomBartModel
...
class System(modeling_bart.BartPreTrainedModel):
    ...
    def __init__(self, config: modeling_bart.BartConfig):
    ...
    def prepare_decoder_input_ids_from_labels(self, labels: torch.Tensor):
        return modeling_bart.shift_tokens_right(labels, self.config.pad_token_id, self.config.decoder_start_token_id)
